import type { Transaction, FinancialSummary, Bank, Category, WebhookPayload, N8NWebhookResponse, ApiResponse } from '../types';
...
class ApiService {
  ...
  // Resumo financeiro
  async getFinancialSummary(period?: string): Promise<ApiResponse<FinancialSummary>> {
